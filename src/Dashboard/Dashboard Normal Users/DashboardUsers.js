...
import GridSystemUser from './GridSystemUser';
    ...
    const drawer = (
        <div className='text-white sideBar'>
            ...
            <List>
                ...
                <ListItem className='button' disablePadding>
                    <ListItemButton className='button' onClick={() => { navigate('/dashboardUsers') }}>
                        <ListItemIcon className='text-white'>
                            <DashboardIcon />
                        </ListItemIcon>
    ...
    return (
        <Box sx={{ display: 'flex', background: 'rgb(220, 225, 228)' }}>
            ...
            <Box component="main"
                ...
                <Routes path="/dashboardUsers" element={<DashboardUsers />}>
                ...
                <footer className='text-center fs-6 mt-4'>
