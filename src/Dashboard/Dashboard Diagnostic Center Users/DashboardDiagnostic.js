...
import GridSystemDiagnostic from './GridSystemDiagnostic';
...
function DashboardDiagnostic(props) {
    const { window } = props;
    ...
    const drawer = (
        <div className='text-white sideBar'>
            ...
            <List>
                ...
                <ListItem className='button' disablePadding>
                    <ListItemButton className='button' onClick={() => { navigate('/dashboardDiagnostic') }}>
                        <ListItemIcon className='text-white'>
                            <DashboardIcon />
                        </ListItemIcon>
            ...
            <List>
                ...
                <ListItem className='logout' disablePadding>
                    <ListItemButton className='button' onClick={() => { navigate('/login') }}>
                        <ListItemIcon className='text-white'>
                            <LogoutIcon />
                        </ListItemIcon>
    ...
    return (
        <Box sx={{ display: 'flex', background: 'rgb(220, 225, 228)' }}>
            ...
            <Box component="main"
                ...
                <footer className='fs-6 text-center mt-4'>
